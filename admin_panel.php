...
<html>
	...
	<body>
			...
			<div class = "navbar-inner">
				<div class = "container-fluid">
					...
					<ul class="nav pull-right">
						...
						<?php
							$agendav_path = "http://edthote.fr/galidav";
		...
		<?php
			...
			// Rebuild all tables of database
		...
		<form action = "test_davical_operations.php" method = "POST" style = "position:fixed;right:0px;top:50px;">
				...
				<tr style = "border-left:solid;border-right:solid">
					<td style = "border-left:solid;border-right:solid; padding:auto;">
						<form action = "test_davical_operations.php" method = "POST">
							...
							<br />
							<input type = "radio" name = "status" value = "teacher" checked />Enseignant<br />
					...
					<td style = "border-left:solid;border-right:solid; padding:auto;">
						<form action = "test_davical_operations.php" method = "POST">
							...
							<br/>
							<input type = "radio" name = "status" value = "student" checked />Élève<br />
					...
					<td style = "border-left:solid;border-right:solid; padding:auto;">
						<form action = "test_davical_operations.php" method = "POST">
							...
							<table style = margin-left:auto;margin-right:auto;>
								...
								<tr>
									<td>
										<input type = "radio" name = "isaclass" value = true checked />Classe<br />
						...
						<form action = "test_davical_operations.php" method = "POST">
							...
							<table style = margin-left:auto;margin-right:auto;>
								<tr>
									<th>Nom : </th>
									<td>
										<input type = "text" name = "subjectgroup" required />
									</td>
								</tr>
								<tr>
									<th>
