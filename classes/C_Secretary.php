<?php
/**
 * \file    C_Secretary.php
 * \brief   Defines the class Secretary.
 * \details Represents a secretary, who is a type of user.
*/
...
class Secretary extends User
{
	...
	*/
	public function __construct($newFamilyName, $newFirstName, $newLogin, $newPassword)
	{
